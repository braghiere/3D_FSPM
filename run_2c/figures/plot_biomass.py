...
df1 = pd.read_csv('/home/renato/groimp_efficient/run_2c/seg58.txt',
...
df2 = pd.read_csv('/home/renato/groimp_efficient/run_2/seg58.txt',
                  delim_whitespace=True,skiprows=0,header=0)
...
df3 = pd.read_csv('/home/renato/groimp_efficient/run_2/root.txt',
                  delim_whitespace=True,skiprows=0,header=0)


root_groimp = np.array(df3['rootMass(mg)'].values)

df4 = pd.read_csv('/home/renato/groimp_efficient/run_2c/root.txt',
                  delim_whitespace=True,skiprows=0,header=0)
...
plt.title('Dicot')
plt.tight_layout()
plt.savefig('/home/renato/groimp_efficient/run_2c/figures/RSD/biomass.png')
#plt.show()
