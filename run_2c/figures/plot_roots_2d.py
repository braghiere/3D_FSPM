...
for fname in filelist:
 ...
 cs = plt.pcolormesh(Xn1, Yn, data1, cmap='BrBG', vmin=0.1, vmax=10)
 cs = plt.pcolormesh(Xn2, Yn, data2, cmap='BrBG', vmin=0.1, vmax=10)
 ...
 plt.tight_layout()
 plt.savefig('/home/renato/groimp_efficient/run_2c/figures/RSD/RSD_%02d.png' %(counter+1))
...
plt.title('Dicot')
plt.tight_layout()
plt.savefig('/home/renato/groimp_efficient/run_2c/figures/RSD/RSD_total.png')
#plt.show()
