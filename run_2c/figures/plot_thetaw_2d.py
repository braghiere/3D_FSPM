...
for fname in filelist:
 ...
 plt.savefig('/home/renato/groimp_efficient/run_2c/figures/thetaw/thetaw_%02d.png' %(counter + 1))
 #plt.show()
...
plt.title('Dicot')
plt.tight_layout()
plt.savefig('/home/renato/groimp_efficient/run_2c/figures/thetaw/thetaw_total.png')
plt.show()
