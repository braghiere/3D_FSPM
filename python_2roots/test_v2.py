                    ...
                    if(min3p.biol.coupled_archi_rld): 
                      ...
                      if (min3p.gen.time_io > (min3p.biol.time_rld - tiny_updtroot)): 
                         ...
                         if(j == 0):
                            ...
                            df41.to_excel("/home/renato/groimp_efficient/beta_1.xls",
                                       index=False, header=False)
                            df42.to_excel("/home/renato/groimp_efficient/beta_2.xls",
                                       index=False, header=False)
                            ...
                            df1 = pd.read_csv('/home/renato/groimp_efficient/transp.txt',header=0, names=['plant#','transpiration'],sep="\t",index_col=False)
                            ...
                            df1 = pd.read_csv('/home/renato/groimp_efficient/root.txt',
                            ...
                            rootbiom1 = root1*10.E-4
                            rootbiom2 = root2*10.E-4
                      ...
                      "---------------------") 
                       ...
                       'j = %d, k = %d, f=point' 
                           ...
                           os.system("rm /home/renato/groimp_efficient/beta_2.xls")
