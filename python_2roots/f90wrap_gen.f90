...
subroutine f90wrap_gen__array__bint2(dummy_this, nd, dtype, dshape, dloc)
    use parm
    use gen, only: gen_bint2 => bint2
    implicit none
    integer, intent(in) :: dummy_this(2)
    integer, intent(out) :: nd
    integer, intent(out) :: dtype
    ...
    nd = 1
    dtype = 5
    if (allocated(gen_bint2)) then
        dshape(1:1) = shape(gen_bint2)
        dloc = loc(gen_bint2)
    else
        dloc = 0
    end if
end subroutine f90wrap_gen__array__bint2
...
subroutine f90wrap_gen__array__qroot2(dummy_this, nd, dtype, dshape, dloc)
    use parm
    use gen, only: gen_qroot2 => qroot2
    implicit none
    integer, intent(in) :: dummy_this(2)
    integer, intent(out) :: nd
    integer, intent(out) :: dtype
    ...
    nd = 1
    dtype = 12
    if (allocated(gen_qroot2)) then
        dshape(1:1) = shape(gen_qroot2)
        dloc = loc(gen_qroot2)
    else
        dloc = 0
    end if
end subroutine f90wrap_gen__array__qroot2

subroutine f90wrap_gen__array__qrootinc2(dummy_this, nd, dtype, dshape, dloc)
    use parm
    use gen, only: gen_qrootinc2 => qrootinc2
    implicit none
    integer, intent(in) :: dummy_this(2)
    integer, intent(out) :: nd
    integer, intent(out) :: dtype
    ...
    nd = 1
    dtype = 12
    if (allocated(gen_qrootinc2)) then
        dshape(1:1) = shape(gen_qrootinc2)
        dloc = loc(gen_qrootinc2)
    else
        dloc = 0
    end if
end subroutine f90wrap_gen__array__qrootinc2

subroutine f90wrap_gen__array__dqroot2(dummy_this, nd, dtype, dshape, dloc)
    use parm
    use gen, only: gen_dqroot2 => dqroot2
    implicit none
    integer, intent(in) :: dummy_this(2)
    integer, intent(out) :: nd
    integer, intent(out) :: dtype
    ...
    nd = 1
    dtype = 12
    if (allocated(gen_dqroot2)) then
        dshape(1:1) = shape(gen_dqroot2)
        dloc = loc(gen_dqroot2)
    else
        dloc = 0
    end if
end subroutine f90wrap_gen__array__dqroot2
