                    ...
                    if(min3p.biol.coupled_archi_rld): 
                      ...
                      if (min3p.gen.time_io > (min3p.biol.time_rld - tiny_updtroot)): 
                         ...
                         if(j == 0):
                            ...
                            df41.to_excel("/home/renato/groimp_efficient/run_1a/beta_1.xls",
                                       index=False, header=False)
                            df42.to_excel("/home/renato/groimp_efficient/run_1a/beta_2.xls",
                                       index=False, header=False)
                            ...
                            df2 = pd.read_csv('/home/renato/groimp_efficient/run_1a/water.soi',sep='\t',names=['time','ET','canopy_int','solar_ratio','scale_tree_growth','transp_pot_sharing'])
                            ...
                            os.system("java -Xmx2000m -jar /home/renato/Downloads/GroIMP-1.5/core.jar --headless /home/renato/Downloads/FSPM_BASIC-run_1a/project.gs")

                            df1 = pd.read_csv('/home/renato/groimp_efficient/run_1a/transp.txt',header=0, names=['plant#','transpiration'],sep="\t",index_col=False)
                            ...
                            df1 = pd.read_csv('/home/renato/groimp_efficient/run_1a/root.txt',
                         ...
                         df3.to_csv('/home/renato/groimp_efficient/run_1a/water.soi', sep='\t', index=False, header=None)

                         df3.to_csv('/home/renato/groimp_efficient/run_1a/water_original_%s.soi' %int(min3p.gen.time_io),sep='\t', index=False, header=None)
                      ...
                      "---------------------") 
                         ...
                         df41.to_csv('/home/renato/groimp_efficient/run_1a/biomrac.txt', sep='\t',index=False, header=None)
                         df42.to_csv('/home/renato/groimp_efficient/run_1a/biomrac2.txt', sep='\t',index=False, header=None)
                         df41.to_csv('/home/renato/groimp_efficient/run_1a/biomrac1_%s.txt' %int(min3p.gen.time_io), sep='\t', index=False, header=None)
                         df42.to_csv('/home/renato/groimp_efficient/run_1a/biomrac2_%s.txt' %int(min3p.gen.time_io), sep='\t', index=False, header=None)
                       ...
                       'j = %d, k = %d, f=point' 
                           ...
                           df81.to_csv('/home/renato/groimp_efficient/run_1a/RWU_1_%s.txt' %int(min3p.gen.time_io),
                             sep='\t', index=False, header=None )
                           df82.to_csv('/home/renato/groimp_efficient/run_1a/RWU_2_%s.txt' %int(min3p.gen.time_io),
                             sep='\t', index=False, header=None )
                           ...
                           os.system("rm /home/renato/groimp_efficient/run_1a/beta_1.xls")
                           os.system("rm /home/renato/groimp_efficient/run_1a/beta_2.xls")
                           ...
                           df41.to_csv('/home/renato/groimp_efficient/run_1a/beta_1_%s.txt' %int(min3p.gen.time_io),
                             sep='\t', index=False, header=None)
                           df42.to_csv('/home/renato/groimp_efficient/run_1a/beta_2_%s.txt' %int(min3p.gen.time_io),
                             sep='\t', index=False, header=None)
                           ...
                           df0 = pd.read_csv('/home/renato/groimp_efficient/run_1a/field.txt',
                       delim_whitespace=True,skiprows=1,header=None,
                       names=["time", "species", "LAI", "nrShoots", "fAbs",
                              "assCO2", "biomAbove", "yield", "harvestIndex",
                              "leafArea","fieldRFR"])

                           df0.to_csv('/home/renato/groimp_efficient/run_1a/field_%s.txt' %int(min3p.gen.time_io), sep='\t', index=False, header=None)

                           df0 = pd.read_csv('/home/renato/groimp_efficient/run_1a/plant.txt',
                        delim_whitespace=True,skiprows=1,header=None,
                        names=["time", "tt", "plant", "strip", "row", "pos",
                           ...
                           df0.to_csv('/home/renato/groimp_efficient/run_1a/plant_%s.txt' %int(min3p.gen.time_io), sep='\t', index=False, header=None)
