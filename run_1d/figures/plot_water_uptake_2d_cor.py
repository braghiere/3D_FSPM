...
for fname in filelist:
 ...
 plt.savefig('/home/renato/groimp_efficient/run_3/figures/transp_%02d.png' %(counter + 1))
 #plt.show()
...
plt.tight_layout()
plt.savefig('/home/renato/groimp_efficient/run_3/figures/transp_total.png')
plt.show()
