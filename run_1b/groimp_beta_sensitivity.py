...
for k in range(0,101):
  ...
  #df0.to_csv('/home/renato/groimp_efficient/run_1b/field_gday_%s.txt' %k ,sep='\t', index=False, header=None)

  #df0.to_csv('/home/renato/groimp_efficient/run_1b/field_clm_%s.txt' %k ,sep='\t', index=False, header=None)

  df0.to_csv('/home/renato/groimp_efficient/run_1b/field_jules_%s.txt' %k ,sep='\t', index=False, header=None)
  ...
  #df0.to_csv('/home/renato/groimp_efficient/run_1b/plant_gday_%s.txt' %k ,sep='\t', index=False, header=None)

  #df0.to_csv('/home/renato/groimp_efficient/run_1b/plant_clm_%s.txt' %k ,sep='\t', index=False, header=None)

  df0.to_csv('/home/renato/groimp_efficient/run_1b/plant_jules_%s.txt' %k ,sep='\t', index=False, header=None)
