...
plt.ylabel("Transpiration (mm.day-1)", labelpad=20)
...
plt.xlim(0,60.05)
plt.ylim(0.,15.0)
plt.savefig('/home/renato/groimp_efficient/analysis_paper/transp_monocot.png',dpi=300)
plt.show()
plt.close("all")
...
plt.xlim(0,60.05)
plt.ylim(0.,15.0)
plt.savefig('/home/renato/groimp_efficient/analysis_paper/transp_dicot.png',dpi=300)
plt.show()
plt.close("all")
