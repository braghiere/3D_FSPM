...
plt.plot(abovebiomass_run1,'k',label='ISO')
plt.plot(abovebiomass_run1c,'k--',label='ISO_beta')
plt.plot(abovebiomass_run1d_a,'b',label='MONO (plant A)')
#plt.plot(abovebiomass_run1d_b,'g--',label='MONO (plant B)')
plt.plot(abovebiomass_run1a_a,'b--',label='MONO_beta (plant A)')
#plt.plot(abovebiomass_run1a_b,'b--',label='MONO_beta (plant B)')
plt.plot(abovebiomass_run3_a,'r',label='INTER')
plt.plot(abovebiomass_run3c_a,'r--',label='INTER_beta')

plt.ylabel("Shoot biomass (g)", labelpad=20)
...
plt.xlim(0,60.05)
plt.ylim(0.,17.0)
plt.savefig('/home/renato/groimp_efficient/analysis_paper/shoot_biomass_monocot.png',dpi=300)
plt.show()
plt.close("all")

plt.plot(abovebiomass_run2,'k',label='ISO')
plt.plot(abovebiomass_run2c,'k--',label='ISO_beta')
#plt.plot(abovebiomass_run2d_a,'b',label='MONO (plant A)')
plt.plot(abovebiomass_run2d_b,'b',label='MONO (plant B)')
#plt.plot(abovebiomass_run2a_a,'b--',label='MONO_beta (plant A)')
plt.plot(abovebiomass_run2a_b,'b--',label='MONO_beta (plant B)')
plt.plot(abovebiomass_run3_b,'r',label='INTER')
plt.plot(abovebiomass_run3c_b,'r--',label='INTER_beta')
...
plt.xlim(0,60.05)
plt.ylim(0.,17.0)
plt.savefig('/home/renato/groimp_efficient/analysis_paper/shoot_biomass_dicot.png',dpi=300)
plt.show()
plt.close("all")
