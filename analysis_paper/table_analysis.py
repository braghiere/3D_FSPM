...
shootroot_run1c = df1_iso_beta['shootrootratio'].values
...
shootroot_run1 = df1_iso['shootrootratio'].values
...
shootroot_run2c = df2_iso_beta['shootrootratio'].values
...
shootroot_run2 = df2_iso['shootrootratio'].values
...
shootroot_run1a_a = df1_mono_beta_a['shootrootratio'].values
...
# Total biomass MONOCOT all cases
print('Total',biom_run1[59],biom_run1c[59],
      biom_run1d_a[59],biom_run1a_a[59],
      biom_run1d_b[59],biom_run1a_b[59],
      biom_run3_a[59],biom_run3c_a[59],
# Total biomass DICOT all cases
      biom_run2[59],biom_run2c[59],
      biom_run2a_a[59],biom_run2a_b[59],
      biom_run2a_a[59],biom_run2a_b[59],
      biom_run3_b[59],biom_run3c_b[59])

# Total shoot MONOCOT all cases
print('Shoot',abovebiomass_run1[59],abovebiomass_run1c[59],
      abovebiomass_run1d_a[59],abovebiomass_run1a_a[59],
      abovebiomass_run1d_b[59],abovebiomass_run1a_b[59],
      abovebiomass_run3_a[59],abovebiomass_run3c_a[59],
# Total shoot DICOT all cases
      abovebiomass_run2[59],abovebiomass_run2c[59],
      abovebiomass_run2d_a[59],abovebiomass_run2a_a[59],
      abovebiomass_run2d_b[59],abovebiomass_run2a_b[59],
      abovebiomass_run3_b[59],abovebiomass_run3c_b[59])

# Total root MONOCOT all cases
print('Root',rootbiomass_run1[59],rootbiomass_run1c[59],
      rootbiomass_run1d_a[59],rootbiomass_run1a_a[59],
      rootbiomass_run1d_b[59],rootbiomass_run1a_b[59],
      rootbiomass_run3_a[59],rootbiomass_run3c_a[59],
# Total root DICOT all cases
      rootbiomass_run2[59],rootbiomass_run2c[59],
      rootbiomass_run2d_a[59],rootbiomass_run2a_a[59],
      rootbiomass_run2d_b[59],rootbiomass_run2a_b[59],
      rootbiomass_run3_b[59],rootbiomass_run3c_b[59])


# Total root MONOCOT all cases
print('Transp',transp_run1[59],transp_run1c[59],
      transp_run1d_a[59],transp_run1a_a[59],
      transp_run1d_b[59],transp_run1a_b[59],
      transp_run3_a[59],transp_run3c_a[59],
# Total root DICOT all cases
      transp_run2[59],transp_run2c[59],
      transp_run2d_a[59],transp_run2a_a[59],
      transp_run2d_b[59],transp_run2a_b[59],
      transp_run3_b[59],transp_run3c_b[59])

sys.exit()
#Statistics

print(' BETA IMPACT - MONOCOT')
print(' Shoot')
print(' ISO_beta/ISO =',(abovebiomass_run1c[59]/abovebiomass_run1[59])*100.,'%')
print(' MONO_beta_A/MONO_A =',(abovebiomass_run1a_a[59]/abovebiomass_run1d_a[59])*100.,'%')
print(' MONO_beta_B/MONO_B =',(abovebiomass_run1a_b[59]/abovebiomass_run1d_b[59])*100.,'%')
print(' INTER_beta/INTER =',(abovebiomass_run3c_a[59]/abovebiomass_run3_a[59])*100.,'%')

print(' BETA IMPACT - DICOT')
print(' Shoot')
print(' ISO_beta/ISO =',(abovebiomass_run2c[59]/abovebiomass_run2[59])*100.,'%')
print(' MONO_beta_A/MONO_A =',(abovebiomass_run2a_a[59]/abovebiomass_run2d_a[59])*100.,'%')
print(' MONO_beta_B/MONO_B =',(abovebiomass_run2a_b[59]/abovebiomass_run2d_b[59])*100.,'%')
print(' INTER_beta/INTER =',(abovebiomass_run3c_b[59]/abovebiomass_run3_b[59])*100.,'%')

print(' BETA IMPACT - MONOCOT')
print(' Root')
print(' ISO_beta/ISO =',(rootbiomass_run1c[59]/rootbiomass_run1[59])*100.,'%')
print(' MONO_beta_A/MONO_A =',(rootbiomass_run1a_a[59]/rootbiomass_run1d_a[59])*100.,'%')
print(' MONO_beta_B/MONO_B =',(rootbiomass_run1a_b[59]/rootbiomass_run1d_b[59])*100.,'%')
print(' INTER_beta/INTER =',(rootbiomass_run3c_a[59]/rootbiomass_run3_a[59])*100.,'%')

print(' BETA IMPACT - DICOT')
print(' Root')
print(' ISO_beta/ISO =',(rootbiomass_run2c[59]/rootbiomass_run2[59])*100.,'%')
print(' MONO_beta_A/MONO_A =',(rootbiomass_run2a_a[59]/rootbiomass_run2d_a[59])*100.,'%')
print(' MONO_beta_B/MONO_B =',(rootbiomass_run2a_b[59]/rootbiomass_run2d_b[59])*100.,'%')
print(' INTER_beta/INTER =',(rootbiomass_run3c_b[59]/rootbiomass_run3_b[59])*100.,'%')


sys.exit()

plt.plot((rootbiomass_run1c/rootbiomass_run1)*100,'k', label='ISO_beta/ISO')
plt.plot((rootbiomass_run1a_a/rootbiomass_run1d_a)*100,'b', label='MONO_beta_A/MONO_A')
#plt.plot((rootbiomass_run1a_b/rootbiomass_run1d_b)*100, label='MONO_beta_B/MONO_B')
plt.plot((rootbiomass_run3c_a/rootbiomass_run3_a)*100,'r', label='INTER_beta/INTER')
plt.title(' BETA IMPACT - MONOCOT')
plt.ylabel("Root biomass (BETA)/ Root biomass (Default) (%)", labelpad=20)
...
plt.ylim(0.,105.5)
plt.legend()
plt.savefig('/home/renato/groimp_efficient/analysis_paper/beta_difference_root_biomass_monocot.png',dpi=300)
plt.show()

plt.plot((rootbiomass_run2c/rootbiomass_run2)*100,'k', label='ISO_beta/ISO')
#plt.plot((rootbiomass_run2a_a/rootbiomass_run2d_a)*100, label='MONO_beta_A/MONO_A')
plt.plot((rootbiomass_run2a_b/rootbiomass_run2d_b)*100,'b', label='MONO_beta_B/MONO_B')
plt.plot((rootbiomass_run3c_b/rootbiomass_run3_b)*100,'r', label='INTER_beta/INTER')
...
plt.ylim(0.,105.5)
plt.legend()
plt.savefig('/home/renato/groimp_efficient/analysis_paper/beta_difference_root_biomass_dicot.png',dpi=300)
plt.show()

plt.plot((abovebiomass_run1c/abovebiomass_run1)*100,'k', label='ISO_beta/ISO')
plt.plot((abovebiomass_run1a_a/abovebiomass_run1d_a)*100,'b', label='MONO_beta_A/MONO_A')
#plt.plot((abovebiomass_run1a_b/abovebiomass_run1d_b)*100, label='MONO_beta_B/MONO_B')
plt.plot((abovebiomass_run3c_a/abovebiomass_run3_a)*100,'r', label='INTER_beta/INTER')
plt.title(' BETA IMPACT - MONOCOT')
plt.ylabel("Shoot biomass (BETA)/ Shoot biomass (Default) (%)", labelpad=20)
plt.xlabel("Time (days)", labelpad=20)
plt.legend()
plt.grid()
plt.tight_layout()
...
plt.ylim(0.,105.5)
plt.legend()
plt.savefig('/home/renato/groimp_efficient/analysis_paper/beta_difference_shoot_biomass_monocot.png',dpi=300)
plt.show()

plt.plot((abovebiomass_run2c/abovebiomass_run2)*100,'k', label='ISO_beta/ISO')
#plt.plot((abovebiomass_run2a_a/abovebiomass_run2d_a)*100, label='MONO_beta_A/MONO_A')
plt.plot((abovebiomass_run2a_b/abovebiomass_run2d_b)*100,'b', label='MONO_beta_B/MONO_B')
plt.plot((abovebiomass_run3c_b/abovebiomass_run3_b)*100,'r', label='INTER_beta/INTER')
plt.title(' BETA IMPACT - DICOT')
plt.ylabel("Shoot biomass (BETA)/ Shoot biomass (Default) (%)", labelpad=20)
plt.xlabel("Time (days)", labelpad=20)
plt.legend()
...
plt.ylim(0.,105.5)
plt.legend()
plt.savefig('/home/renato/groimp_efficient/analysis_paper/beta_difference_shoot_biomass_dicot.png',dpi=300)
plt.show()
