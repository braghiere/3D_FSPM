...
for fname in filelist:
 ...
 plt.grid()
 plt.tight_layout()
 plt.savefig('/home/renato/groimp_efficient/analysis_paper/figures/10_cm/monocot/RSD_iso/iso_monocot_RSD_%02d.png' %(counter+1), dpi=300)
...
plt.title('Monocot')
plt.tight_layout()
plt.savefig('/home/renato/groimp_efficient/analysis_paper/figures/10_cm/monocot/RSD_iso/iso_monocot_RSD_total.png')
#plt.show()
