...
for fname in filelist:
 ...
 #Mono_beta
 f3 = open(os.path.join(dirname3,fname),"r")
 #Mono_beta
 ...
 plt.xlabel("Root surface density (m$^{-2}$m$^{-3}$)", labelpad=20)
 plt.legend()
 plt.tight_layout()
 plt.xlim(0.01,1000.)
 plt.ylim(0.,1.0)
 plt.savefig('/home/renato/groimp_efficient/run_1c/paper_fig/RSD_vertical/RSD_vertical_%02d.png' %(counter+1),dpi=300)
