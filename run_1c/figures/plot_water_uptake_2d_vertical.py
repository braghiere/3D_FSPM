...
for fname in filelist:
 ...
 f12 = interp2d(x1, z1, transp12, kind='cubic')
 f22 = interp2d(x2, z2, transp22, kind='cubic')
 ...
 plt.legend()
 plt.tight_layout()
 plt.xlim(-0.05e-8,2.05e-8)
 plt.ylim(0.,1.0)
 plt.savefig('/home/renato/groimp_efficient/run_1c/paper_fig/transp_vertical/transp_vertical_%02d.png' %(counter+1),dpi=300)
