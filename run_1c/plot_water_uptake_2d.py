...
for fname in filelist:
 ...
 plt.savefig('/home/renato/groimp_efficient/run_1c/paper_fig/transp/transp_%02d.png' %(counter + 1))
 #plt.show()
...
plt.title('Cereal')
plt.tight_layout()
plt.savefig('/home/renato/groimp_efficient/run_1c/paper_fig/transp/transp_total.png')
#plt.show()
