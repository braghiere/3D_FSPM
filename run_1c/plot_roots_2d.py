...
for fname in filelist:
 ...
 plt.tight_layout()
 plt.savefig('/home/renato/groimp_efficient/run_1c/paper_fig/RSD/RSD_%02d.png' %(counter+1),dpi=300)
...
with open ('/home/renato/groimp_efficient/run_1c/paper_fig/RSD/volume_run1c.txt','w') as f:
   for item in biomrsd1:
       f.write("%s\n" % item)

with open ('/home/renato/groimp_efficient/run_1c/paper_fig/RSD/volume_run1.txt','w') as f:
   for item in biomrsd2:
       f.write("%s\n" % item)

plt.plot(biomrsd1,'b--',label='With Beta')
plt.plot(biomrsd2,'b-',label='Without Beta')
...
plt.title('Monocot')
plt.tight_layout()
plt.savefig('/home/renato/groimp_efficient/run_1c/paper_fig/RSD/RSD_total.png')
#plt.show()
