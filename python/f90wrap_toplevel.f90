...
subroutine f90wrap_dratemin_new(totc, c, cx, gammac, gammax, ratem, phim, &
    phimold, aream, drtinc, im, ivol, sw, por, rootdens)
    implicit none
...
subroutine f90wrap_ratemin_new(totc, c, cx, gammac, gammax, ratem, phim, &
    phimold, aream, im, sw, por, rootdens)
    implicit none
...
subroutine f90wrap_zero_r4(r4, n1, n2, n3)
    implicit none
    external zero_r4
    
    real :: r4
    !f2py intent(inout) r4
    integer :: n1
    !f2py intent(inout) n1
    integer :: n2
    !f2py intent(inout) n2
    integer :: n3
    !f2py intent(inout) n3
    call zero_r4(r4, n1, n2, n3)
end subroutine f90wrap_zero_r4
