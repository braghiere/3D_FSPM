	              ...
	              #updtrootdensity()
                    ...
                    if(min3p.biol.coupled_archi_rld): 
                      ...
                      if (min3p.gen.time_io > (min3p.biol.time_rld - tiny_updtroot)): 
                         ...
                         if(j == 0):
                            ...
                            df4.to_excel("/home/renato/groimp_efficient/run_2c/beta_1.xls",
                            ...
                            df2 = pd.read_csv('/home/renato/groimp_efficient/run_2c/feddes.soi',sep='\t',names=['time','ET','canopy_int','solar_ratio','scale_tree_growth'])
                            ...
                            os.system("java -Xmx2000m -jar /home/renato/Downloads/GroIMP-1.5/core.jar --headless /home/renato/Downloads/FSPM_BASIC-run_2c/project.gs")

                            df1 = pd.read_csv('/home/renato/groimp_efficient/run_2c/transp.txt',header=0, names=['transpiration'])
                            ...
                            df1 = pd.read_csv('/home/renato/groimp_efficient/run_2c/root.txt',
                                          header=0, names=['rootbiom'])
                            root = df1.rootbiom.values

                            for k in range(0,len(root)-1):
                                root[k] = root[k+1] - root[k]
                         ...
                         df3.to_csv('/home/renato/groimp_efficient/run_2c/feddes.soi', sep='\t', index=False, header=None )

                         df3.to_csv('/home/renato/groimp_efficient/run_2c/feddes_original_%s.soi' %int(min3p.gen.time_io),sep='\t', index=False, header=None)
           		 ...
           		 for k in range(0,len(root)-1):
                      ...
                      "---------------------") 
                         ...
                         df4.to_csv('/home/renato/groimp_efficient/run_2c/biomrac.txt', sep='\t',index=False, header=None)
                         df4.to_csv('/home/renato/groimp_efficient/run_2c/biomrac_%s.txt' %int(min3p.gen.time_io), sep='\t', index=False, header=None)
                       ...
                       'j = %d, k = %d, f=point' 
                           ...
                           df8.to_csv('/home/renato/groimp_efficient/run_2c/RWU_%s.txt' %int(min3p.gen.time_io),
                           ...
                           os.system("rm /home/renato/groimp_efficient/run_2c/beta_1.xls")
                           ...
                           df4.to_csv('/home/renato/groimp_efficient/run_2c/beta_1_%s.txt' %int(min3p.gen.time_io),
                             sep='\t', index=False, header=None)
                           ...
                           df0 = pd.read_csv('/home/renato/groimp_efficient/run_2c/field.txt',
                       delim_whitespace=True,skiprows=1,header=None,
                       names=["time", "species", "LAI", "nrShoots", "fAbs",
                              "assCO2", "biomAbove", "yield", "harvestIndex",
                              "leafArea","fieldRFR"])

                           df0.to_csv('/home/renato/groimp_efficient/run_2c/field_%s.txt' %int(min3p.gen.time_io), sep='\t', index=False, header=None)

                           df0 = pd.read_csv('/home/renato/groimp_efficient/run_2c/plant.txt',
                        delim_whitespace=True,skiprows=1,header=None,
                        names=["time", "tt", "plant", "strip", "row", "pos",
                           ...
                           df0.to_csv('/home/renato/groimp_efficient/run_2c/plant_%s.txt' %int(min3p.gen.time_io), sep='\t', index=False, header=None)
