...
class Gen(f90wrap.runtime.FortranModule):
    ...
    Defined at ../src/gen.f lines 1-1614
    ...
    def qrootinc(self):
        ...
        Defined at ../src/gen.f line 1366
    ...
    def dqroot(self):
        ...
        Defined at ../src/gen.f line 1367
    ...
    def totvsmass(self):
        ...
        Defined at ../src/gen.f line 1382
    ...
    def culabsbalvs(self):
        ...
        Defined at ../src/gen.f line 1383
    ...
    def under_relax(self):
        ...
        Defined at ../src/gen.f line 1490
    ...
    def msolvit_vs(self):
        ...
        Defined at ../src/gen.f line 1560
    ...
    def qwater(self):
        ...
        Defined at ../src/gen.f line 1604
    ...
    def backup_frequency(self):
        ...
        Defined at ../src/gen.f line 1609
...
def sptldisc():
    ...
    Defined at ../src/sptldisc.f lines 107-303
	          ...
	          #updtrootdensity()
                  ...
                  if(biol.coupled_archi_rld): 
                    ...
                    if (gen.time_io > (biol.time_rld - tiny_updtroot)): 
                       ...
                       x_g = np.tile(np.linspace(gen.xmin,gen.xmax,num=gen.nvx,dtype = np.float32),gen.nvx) 
                       y_g = np.zeros(gen.nn,dtype = np.float32) 
                       z_g = np.repeat(np.linspace(gen.zmin,gen.zmax,num=gen.nvz,dtype = np.float32),gen.nvz)
                       ...
                       if(flag == 1):
                         ...
                         lib.COMPUTE(flag, gen.time_io, delt_MIN3P, z_max, 
                                     ...
                                     gen.x_g, gen.y_g, gen.z_g, humidity)
