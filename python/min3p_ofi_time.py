...
lib = ctypes.cdll.LoadLibrary('../ArchiSimple/_ArchiSimple.so')
...
class Gen(f90wrap.runtime.FortranModule):
    ...
    def igsa_last(self):
        """
        Elemexternal in pythonent igsa_last ftype=integer (type_i4) pytype=int
    ...
    def idetail_rt(self):
        ...
        Defined at ../src/gen.f line 1034
    ...
    def iter_seep(self):
        ...
        Defined at ../src/gen.f line 1250
    ...
    def hydraulic_head(self):
        ...
        Defined at ../src/gen.f line 1256
    ...
    def mass_balance_vs(self):
        ...
        Defined at ../src/gen.f line 1259
    ...
    def binev(self):
        ...
        Defined at ../src/gen.f line 1346
    ...
    def qroot(self):
        ...
        Defined at ../src/gen.f line 1358
    ...
    def totvsmass(self):
        ...
        Defined at ../src/gen.f line 1375
    ...
    def culabsbalvs(self):
        ...
        Defined at ../src/gen.f line 1376
    ...
    def iabvs(self):
        ...
        Defined at ../src/gen.f line 1420
    ...
    def nbvs(self):
        ...
        Defined at ../src/gen.f line 1422
    ...
    def ibcvs(self):
        ...
        Defined at ../src/gen.f line 1423
    ...
    def ibcrt(self):
        ...
        Defined at ../src/gen.f line 1424
    ...
    def update_bcvs(self):
        ...
        Defined at ../src/gen.f line 1426
    ...
    def dinc_vs(self):
        ...
        Defined at ../src/gen.f line 1472
    ...
    def srelfac_vs(self):
        ...
        Defined at ../src/gen.f line 1476
    ...
    def ittot_vs(self):
        ...
        Defined at ../src/gen.f line 1480
    ...
    def upstream(self):
        ...
        Defined at ../src/gen.f line 1482
    ...
    def comp_relax(self):
        ...
        Defined at ../src/gen.f line 1484
    ...
    def avs(self):
        ...
        Defined at ../src/gen.f line 1530
    ...
    def resvs(self):
        ...
        Defined at ../src/gen.f line 1533
    ...
    def jafvs(self):
        ...
        Defined at ../src/gen.f line 1542
    ...
    def rmupdate(self):
        ...
        Defined at ../src/gen.f line 1582
    ...
    def iwork(self):
        ...
        Defined at ../src/gen.f line 1584
    ...
    def itsolv(self):
        ...
        Defined at ../src/gen.f line 1586
    ...
    def lwork(self):
        ...
        Defined at ../src/gen.f line 1588
    ...
    def rsrt_cnt(self):
        ...
        Defined at ../src/gen.f line 1600
    ...
    def backup_frequency(self):
        ...
        Defined at ../src/gen.f line 1602
    ...
    def restart_sim(self):
        ...
        Defined at ../src/gen.f line 1603
    ...
    def ovr_sat(self):
        ...
        Defined at ../src/gen.f line 1606
    ...
    def __str__(self):
        ...
        ret.append(',\n    gafluxout : ')
        ret.append(repr(self.gilogafluxout))
        ret.append(',\n    cstordiff : ')
...
class Root_Modu(f90wrap.runtime.FortranModule):
    ...
    Defined at ../src/root_modu.f lines 1-42
...
def drateint_new(rate, totc, c, cx, gammac, gammax, phim, drtinc, iaq, sw, por, \
    ...
    Defined at ../src/drateint_new.f lines 235-591
...
def dratemin_new(totc, c, cx, gammac, gammax, ratem, phim, phimold, aream, \
    ...
    Defined at ../src/dratemin_new.f lines 240-728
...
def mem_etr():
    ...
    Defined at ../src/mem_etr.f lines 46-143
...
def rateint_new(rate, totc, c, cx, gammac, gammax, phim, iaq, sw, por, rootdens, \
    ...
    Defined at ../src/rateint_new.f lines 222-532
...
def ratemin_new(totc, c, cx, gammac, gammax, ratem, phim, phimold, aream, im, \
    ...
    Defined at ../src/ratemin_new.f lines 219-677
...
def timeloop():
    ...
    Defined at ../src/timeloop.f lines 270-721
...
def updtrootdensity():
    ...
    Defined at ../src/updtrootdensity.f90 lines 55-309
...
def main():
    ...
    gen.show_module = True
    gen.analyt_deriv_rt = False
    ...
    try:
      print(gen.nxx,gen.nvix,gen.xmin,gen.xmax)
      print(gen.xg)
      print('ARRAY IS NOT NULL IN POSITION: 3')
      sys.exit()
    except:
      print('ARRAY IS NULL IN POSITION: 3')
      sys.exit()


    #equilibrium or reaction path simulation

    if (not gen.reactive_transport and gen.geo_chemistry):
	batreac()
	...
	setsize(gen.redox_equil_rt)
	if (chem.nm > 0):
           chem.finite_minerals = True
        ...
        if (gen.gb_output):
          ...
          #assign unit numbers for output of transient data
            ...
            if (chem.ng == 0 and chem.nm != 0): 
             ...
             #FG, 3, new subroutine without gaz related arrays and the unit number
                tprfrtlcg0(totcnew(1,ivol),cnew(1,ivol),cx(1,ivol), 
             ...
             #related arrays and unit numbers
                tprfrtlcm0(totcnew(1,ivol),cnew(1,ivol),cx(1,ivol), 
                        gamma(1,ivol),gamma(nc-1,ivol),
	     ...
	     sys.exit("Error message")
             ...
             #FG, 3, 4 if neither ng = 0 nor nm = 0  (initial subroutine)  
                tprfrtlc(totcnew(1,ivol),cnew(1,ivol),cx(1,ivol),
    ...
    if (gen.varsat_flow and gen.transient_flow and gen.mass_balance_vs):
        msysvs()


    #compute initial system mass - reactive transport

    if (gen.mass_balance_rt):
        msysrt()
    ...
    #reactive transport
    if ((gen.varsat_flow and gen.transient_flow) or gen.reactive_transport):
	 ...
	 if (gen.chemical_water):
            zero_r8(gen.qwater,gen.nn,1,1) 
	 ...
	 gen.rsrt_cnt = r0
         ...
         if (gen.restart_sim):
	    restart_r()
	    gen.time = gen.time_io*gen.time_factor
	    gen.restart_sim= False

         if (gen.reactive_transport):
            gen.ittot_rt = 0
            gen.itsolvtot_rt = 0
            if (gen.update_activity_rt == 'no_update'):
                gen.update_activity = 'no_update'
            elif (gen.update_activity_rt == 'time_lagged'):
                gen.update_activity = 'time_lagged'
            elif (gen.update_activity_rt == 'double_update'):
                gen.update_activity = 'double_update'
         ...
         while (gen.time < (gen.tfinal-tiny_time)):
               gen.mtime = gen.mtime + 1

               #variable time stepping

               if (gen.mtime == 1 and (not gen.restart_sim)): 

	         if (gen.varsat_flow and gen.reactive_transport):
                    #initialize iupsg variable 
                    #(updated after each N-R iteration, in reactran)
                    
                    iupsg = []
	            for i1 in range(1,gen.njavs):
	               iupsg.append('a')

               elif (gen.mtime > 1 or gen.restart_sim):

                     #assign new time step for global simulation
                     #flow and reactive transport

                     if (gen.varsat_flow and gen.reactive_transport):
                        if (gen.transient_flow and gen.variably_saturated):
                              gen.delt = min(gen.delt_vs,gen.delt_rt)
                        else:
                              gen.delt = gen.delt_rt  

                       #flow only

                     elif (gen.varsat_flow and (not gen.reactive_transport)):
                          if (gen.transient_flow and gen.variably_saturated):
                             gen.delt = gen.delt_vs  
                          else:
                             gen.delt = gen.delt   

                       #reactive transport only

                     elif ((not gen.varsat_flow) and (gen.reactive_transport)):
                            gen.delt = gen.delt_rt  
                     ...
                     if (gen.update_bcvs):
	               if ((gen.time + gen.delt) > (gen.time_bcvs*gen.time_factor)):
	                  gen.delt = gen.time_bcvs*gen.time_factor-gen.time
	                  gen.delt = max(gen.delt, gen.deltmin)
                     ...
                     if (biol.root_uptake):
	               if ((gen.time+gen.delt) > (biol.time_soi*gen.time_factor)):
	                  gen.delt = biol.time_soi*gen.time_factor-gen.time
	                  gen.delt = max(gen.delt,gen.deltmin)
               ...
               gen.time = gen.time - gen.delt
               gen.mtime_f = gen.mtime_f + 1
               gen.reduce_timestep = False
               #gen.reduce_timestep = 0
               gen.delt = rhalf*gen.delt  #additional time step reduction

               label .onethousand

               if (gen.delt < (gen.deltmin - tiny)):
               ...
               if (gen.time > (gen.igstime + tiny_time)):
                    gen.delt = gen.delt + gen.igstime - gen.time
                    gen.time = gen.igstime
                    
                    #print('third max/ delt = ',gen.delt ) 
               #make sure solution time will be consistent with target
               # read times for source chemistry

               if (gen.transient_source):
                  if (gen.time > (gen.tsrc[gen.itsrc]+tiny_time)):
                     gen.delt = gen.delt + gen.tsrc[gen.itsrc] - gen.time    
                     gen.time = gen.tsrc[gen.itsrc]
                     #print('fourth max/ delt = ',gen.delt ) 

               #  convert current solution time and time step to I/O units

               gen.time_io = gen.time/gen.time_factor
               gen.delt_io = gen.delt/gen.time_factor

               #  write run specific information to log file

               if (gen.idetail_vs > 0 and gen.transient_flow or 
                   gen.idetail_rt > 0):
		      ...
		      #write(ilog,'(/72a)')('-',i=1,72)
 	          ...
 	          #print(' timestep:',gen.mtime,'time:',gen.time_io,
                  ...
                  print(" timestep: %i time: %.3e %i delt: %.3e %i" 
                         % (gen.mtime,gen.time_io,gen.l_time_unit,gen.delt_io,
                           gen.l_time_unit))

               if (gen.varsat_flow and gen.transient_flow):
                    tranflow()
                    #convergence failure 
                    #restart newton iteration with reduced timestep

                    if (gen.reduce_timestep): 
               ...
               if (gen.varsat_flow and gen.mass_balance_vs):
                   mbalvs()
               ...
               if (gen.gs_output):
                 ...
                 if (gen.time >= (gen.igstime-tiny_time)):
                    #report to screen
                    print(' ')
                    print(' write contour data, T = ', gen.time_io, gen.l_time_unit)
                    print(' -------------------------------'
                          '-------------------------------')
                    ...
                    if (gen.reactive_transport):
                       outputrt()
                    gen.igstime = gen.igstime + 1.0
 
               #write transient data to output file
               #every ngb_step time step and after completion of solution
               if (gen.gb_output):
                  gen.igb_step = gen.igb_step + 1
                  if (gen.igb_step == gen.ngb_step 
                      or gen.time > (gen.tfinal-tiny_time)):
                      if (gen.transient_flow or gen.reactive_transport):
                         for igb in range (0,gen.ngb):
                            #assign unit numbers for output of transient data
                            tranunit[igb]
                            ivol = gen.ngb_vol[igb]
	          ...
	          #updtrootdensity()
                  ...
                  if(biol.inside_rld):
                     if (gen.time_io > (biol.time_rld-tiny_updtroot)):
                         ...
                         for ivol in range(0,gen.nn):
                             ...
                             #                    biol.rld[ivol])
                             file_rlddata.write(biol.time_rld,gen.xg[ivol],
                                                 gen.yg[ivol],gen.zg[ivol],
                                                 biol.rld[ivol])
                  ...
                  if(biol.coupled_archi_rld): 
                    ...
                    if (gen.time_io > (biol.time_rld - tiny_updtroot)): 
                       ...
                       x_g = np.zeros(gen.nn, dtype = np.float64)
                       y_g = np.zeros(gen.nn, dtype = np.float64)
                       z_g = np.zeros(gen.nn, dtype = np.float64)
                       humidity = np.zeros(gen.nn, dtype = np.float64)
                       ...
                       for ivol in range(0,gen.nn):   
                          ...
                          #print(x_g[ivol],y_g[ivol],z_g[ivol],humidity[ivol])
                       ...
                       #x_g = np.tile(np.linspace(0,x_max,num=50,dtype = np.float32),50)  
                       #z_g = np.repeat(np.linspace(0,z_max,num=50,dtype = np.float32),50)
                       ...
                       for ivol in range(0,gen.nn):
                           ...
                           file_rlddata.write("%f %f %f %f %f\n" % (biol.time_rld,
                                           ...
                                           z_g.item(ivol),biol.rld.item(ivol)))
