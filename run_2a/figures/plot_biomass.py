...
df1 = pd.read_csv('/home/renato/groimp_efficient/run_3c/seg60.txt',
...
df2 = pd.read_csv('/home/renato/groimp_efficient/run_3c/seg60_2.txt',
                  delim_whitespace=True,skiprows=0,header=0)
...
df3 = pd.read_csv('/home/renato/groimp_efficient/run_3c/root.txt',
                  delim_whitespace=True,skiprows=0,header=0)
...
plt.title('Cereal')
plt.tight_layout()
plt.savefig('/home/renato/groimp_efficient/run_3c/figures/RSD/biomass.png')
#plt.show()
