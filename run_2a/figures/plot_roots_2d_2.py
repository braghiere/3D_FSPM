...
dirname1 = "/home/renato/groimp_efficient/run_2d/"
# MONOCROP WITH BETA
dirname2 = "/home/renato/groimp_efficient/run_2a/"
...
for fnumber in element:
 ...
 print ' run_1d: dicot A=', biomrsd1[counter]
 print ' run_1a: dicot_beta A=', biomrsd12[counter]
 print ' run_1d: dicot B=', biomrsd2[counter]
 print ' run_1a: dicot_beta B=', biomrsd22[counter]

plt.plot(biomrsd1,'b-',label='Dicot A')
plt.plot(biomrsd2,'r-',label='Dicot B')
plt.plot(biomrsd3,'k-',label='Total')

plt.plot(biomrsd12,'b--',label='Dicot A')
plt.plot(biomrsd22,'r--',label='Dicot B')
