...
# MONOCROP WITHOUT BETA
dirname1 = "/home/renato/groimp_efficient/run_1d/"
# MONOCROP WITH BETA
dirname2 = "/home/renato/groimp_efficient/run_1a/"
...
for fnumber in element:
 ...
 print ' run_1d: monocot A=', biomrsd1[counter]
 print ' run_1a: monocot_beta A=', biomrsd12[counter]
 print ' run_1d: monocot B=', biomrsd2[counter]
 print ' run_1a: monocot_beta B=', biomrsd22[counter]

plt.plot(biomrsd1,'b-',label='Monocot A')
plt.plot(biomrsd2,'r-',label='Monocot B')
plt.plot(biomrsd3,'k-',label='Total')

plt.plot(biomrsd12,'b--',label='Monocot A')
plt.plot(biomrsd22,'r--',label='Monocot B')
