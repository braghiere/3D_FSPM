...
for fname in filelist:
 ...
 # scipy interp. cubic
 f1 = interp2d(x1, z1, transp1tot, kind='cubic')
 f2 = interp2d(x2, z2, transp2tot, kind='cubic')
 ...
 plt.savefig('/home/renato/groimp_efficient/run_3/figures/transp_new/transp_%02d.png' %(counter + 1))
 #plt.show()
...
# plt.title('DAY = 94')
plt.ylim(0.,max(biomrsd1.max(),max(biomrsd2.max(),biomrsd3.max())))
plt.legend()
plt.title('Two plants')
plt.tight_layout()
plt.savefig('/home/renato/groimp_efficient/run_3/figures/transp_new/transp_total.png')
plt.show()
