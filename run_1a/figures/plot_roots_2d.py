...
dirname = "/home/renato/groimp_efficient/run_1a/"
...
for fnumber in element:
 ...
 cs = plt.pcolormesh(Xn, Yn, data1, cmap='BrBG', vmin=0.01, vmax=5)
 cs.cmap.set_under('w')
 cbar = plt.colorbar()
...
plt.plot(biomrsd1,label='Monocot A')
plt.plot(biomrsd2,label='Monocot B')
